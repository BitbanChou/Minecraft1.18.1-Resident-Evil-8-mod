//package com.joy187.re8joymod.common.world.portal;
//
//import com.joy187.re8joymod.common.blocks.RE8PortalBlock;
//import com.joy187.re8joymod.common.init.ModBlocks;
//import com.joy187.re8joymod.common.init.ModPOIs;
...
////                        BlockState blockstate1 = i3 < 0 ? ModBlocks.DHANDS_BLOCK.get().defaultBlockState() : Blocks.AIR.defaultBlockState();
...
////                    this.level.setBlock(mutablePos, ModBlocks.DHANDS_BLOCK.get().defaultBlockState(), 3);
////                }
////            }
////        }
////
////        BlockState kaupenPortal = ModBlocks.RE8_PORTAL.get().defaultBlockState().setValue(RE8PortalBlock.AXIS, axis);
////
...
////        boolean destinationIsUG = level.dimension() == DimensionInit.RE8_DIMENSTON_WORLD;
////        if (entity.level.dimension() != DimensionInit.RE8_DIMENSTON_WORLD && !destinationIsUG) {
////            return null;
////        }
////        else {
...
////                }
////                return PortalSize.createPortalInfo(level, result, axis, vector3d, entity.getDimensions(entity.getPose()), entity.getDeltaMovement(), entity.yRot, entity.xRot);
////
////                //return PortalSize.getRelativePosition(level, result, axis, vector3d, entity.getDimensions(entity.getPose()));
////            }).orElse(null);
////        }
////    }
////
...
////
////    @Override
////    public boolean playTeleportSound(ServerPlayer player, ServerWorld sourceWorld, ServerWorld destWorld) {
////        return false;
////    }
////}
//public class ModTeleporter implements net.minecraftforge.common.util.ITeleporter {
//    protected final ServerWorld level;
//
//    public ModTeleporter(ServerWorld p_i1963_1_) {
...
//            return p_242952_0_ == ModPOIs.RE8_PORTAL.get();
...
//                    this.level.setBlock(blockpos$mutable, ModBlocks.DHANDS_BLOCK.get().defaultBlockState(), 3);
//                }
//            }
//        }
//
//        BlockState blockstate = ModBlocks.RE8_PORTAL.get().defaultBlockState().setValue(RE8PortalBlock.AXIS, p_242956_2_);
//
//        for(int j2 = 0; j2 < 2; ++j2) {
//            for(int l2 = 0; l2 < 3; ++l2) {
