...
public class BenehouseStructure extends Structure<NoFeatureConfig> {
    public BenehouseStructure(Codec<NoFeatureConfig> codec) {
        super(codec);
    }

    @Override
    public Structure.IStartFactory<NoFeatureConfig> getStartFactory() {
        return BenehouseStructure.Start::new;
    }
...
//            new MobSpawnInfo.Spawners(EntityInit.BELA.get(), 5, 1, 1),
//            new MobSpawnInfo.Spawners(EntityInit.CASSANDRA.get(), 5, 1, 2),
//            new MobSpawnInfo.Spawners(EntityInit.DANIELA.get(), 5, 1, 2)
    );

    private static final List<MobSpawnInfo.Spawners> STRUCTURE_CREATURES = ImmutableList.of(
//            new MobSpawnInfo.Spawners(EntityType.SHEEP, 10, 1, 3),
//            new MobSpawnInfo.Spawners(EntityType.RABBIT, 10, 1, 3)
    );
        ...
        public void generatePieces(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn, NoFeatureConfig config) {
            ...
            JigsawManager.addPieces(
                    ...
                    new VillageConfig(() -> dynamicRegistryManager.registryOrThrow(Registry.TEMPLATE_POOL_REGISTRY)
                            ...
                            .get(new ResourceLocation(Utils.MOD_ID, "bene_house/start_pool")),
