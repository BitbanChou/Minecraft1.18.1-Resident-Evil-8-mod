...
public class ChurchStructure extends Structure<NoFeatureConfig> {

    public ChurchStructure(Codec<NoFeatureConfig> codec) {
        super(codec);
    }

    @Override
    public IStartFactory<NoFeatureConfig> getStartFactory() {
        return ChurchStructure.Start::new;
    }
    ...
    private static final List<MobSpawnInfo.Spawners> STRUCTURE_MONSTERS = ImmutableList.of(
            new MobSpawnInfo.Spawners(EntityType.ILLUSIONER, 5, 1, 2),
            new MobSpawnInfo.Spawners(EntityType.VINDICATOR, 2, 1, 2),
            new MobSpawnInfo.Spawners(EntityInit.BEIBABY.get(), 1, 1, 2)
    );

    private static final List<MobSpawnInfo.Spawners> STRUCTURE_CREATURES = ImmutableList.of(
            new MobSpawnInfo.Spawners(EntityType.PIG, 7, 1, 3),
            new MobSpawnInfo.Spawners(EntityType.COW, 5, 1, 3)
    );
        ...
        public void generatePieces(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn, NoFeatureConfig config) {
            ...
            JigsawManager.addPieces(
                    ...
                    new VillageConfig(() -> dynamicRegistryManager.registryOrThrow(Registry.TEMPLATE_POOL_REGISTRY)
                            ...
                            .get(new ResourceLocation(Utils.MOD_ID, "church/start_pool")),
