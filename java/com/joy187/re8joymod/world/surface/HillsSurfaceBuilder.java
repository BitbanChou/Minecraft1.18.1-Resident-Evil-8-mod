...
public class HillsSurfaceBuilder extends SurfaceBuilder<SurfaceBuilderConfig> {
    public static final BlockState WASTELAND_BLOCK = ModBlocks.WASTELAND_ROCK_BLOCK.get().defaultBlockState();
    public static final BlockState WASTELAND_ROCK_BLOCK = ModBlocks.WASTELAND_ROCK_BLOCK.get().defaultBlockState();
    public static final BlockState PODZ_STONE = ModBlocks.WASTELAND_ROCK_BLOCK.get().defaultBlockState();
    ...
    public HillsSurfaceBuilder(Codec<SurfaceBuilderConfig> codec) {
        super(codec);
    }
