...
public class ForestSurfaceBuilder extends SurfaceBuilder<SurfaceBuilderConfig> {
    public static final BlockState WASTELAND_BLOCK = Blocks.GRASS_BLOCK.defaultBlockState();
    public static final BlockState WASTELAND_ROCK_BLOCK = Blocks.GRASS_BLOCK.defaultBlockState();
    public static final BlockState PODZ_STONE = Blocks.GRASS_BLOCK.defaultBlockState();
    ...
    public ForestSurfaceBuilder(Codec<SurfaceBuilderConfig> codec) {
        super(codec);
    }
