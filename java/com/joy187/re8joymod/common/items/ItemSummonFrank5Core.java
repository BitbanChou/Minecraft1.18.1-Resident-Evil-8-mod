...
public class ItemSummonFrank5Core extends PickaxeItem {
    public ItemSummonFrank5Core(IItemTier toolMaterial, int attackDamage, float attackSpeed, Properties itemProperties) {
    ...
    public ActionResult<ItemStack> use(World p_77659_1_, PlayerEntity p_77659_2_, Hand p_77659_3_) {
        ...
        EntitySummonSturm e = new EntitySummonSturm(EntityInit.SUMMONFRANK5.get(), p_77659_2_.level);
