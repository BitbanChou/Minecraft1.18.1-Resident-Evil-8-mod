...
import com.joy187.re8joymod.common.items.ItemSniperAmmo;
...
public class ItemF2 extends ShootableItem implements IVanishable {

//    private static final ResourceLocation SCOPE_OVERLAY_TEXTURE =
//            new ResourceLocation(Utils.MOD_ID, "textures/gui/hp_scope.png");

    private int click=0;
    public ItemF2(){ super(new ItemF2.Properties().tab(RegistryEvents.RE8GROUP).stacksTo(1));}
    ...
    public void inventoryTick(ItemStack p_77663_1_, World p_77663_2_, Entity p_77663_3_, int p_77663_4_, boolean p_77663_5_) {
        if(p_77663_3_ instanceof PlayerEntity)
        {
            ...
            if(item.getItem() == ModItems.F2RIFLE.get() || item.getItem() == ModItems.SA110.get())
            {
                Main.PROXY.F2Scope();
            }
            else{
    ...
    public void appendHoverText(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn){
        ...
        tooltip.add(ITextComponent.nullToEmpty(TextFormatting.GOLD+"Ammo Type:Sniper Rifle Ammo"));
    }
...
//    }
    ...
    {
        if (this.isSniperAmmo(player.getItemInHand(Hand.OFF_HAND)))
        {
            return player.getItemInHand(Hand.OFF_HAND);
        }
        else if (this.isSniperAmmo(player.getItemInHand(Hand.MAIN_HAND)))
        {
