...
public class MirandaSuit extends BipedModel {
	...
	public MirandaSuit() {
		...
		Body_r1.setPos(0.5F, -13.0F, -3.5F);
		Body.addChild(Body_r1);
		setRotationAngle(Body_r1, -0.6109F, 0.0F, 0.0F);
		Body_r1.texOffs(44, 7).addBox(-5.0F, -4.0F, -3.5F, 9.0F, 6.0F, 5.0F, 0.0F, false);

		Body_r2 = new ModelRenderer(this);
		Body_r2.setPos(-0.5F, -19.5F, 5.0F);
		Body.addChild(Body_r2);
		setRotationAngle(Body_r2, 0.3927F, 0.0F, 0.0F);
		Body_r2.texOffs(86, 109).addBox(-2.5F, -0.5F, -1.0F, 5.0F, 3.0F, 2.0F, 0.0F, false);

		Body_r3 = new ModelRenderer(this);
		Body_r3.setPos(9.5F, -19.0F, -2.0F);
		Body.addChild(Body_r3);
		setRotationAngle(Body_r3, 0.0F, 0.0F, -0.1745F);
		Body_r3.texOffs(38, 38).addBox(-3.5F, -1.0F, -3.0F, 5.0F, 2.0F, 6.0F, 0.0F, true);

		Body_r4 = new ModelRenderer(this);
		Body_r4.setPos(-9.5F, -19.0F, -2.0F);
		Body.addChild(Body_r4);
		setRotationAngle(Body_r4, 0.0F, 0.0F, 0.1745F);
		Body_r4.texOffs(38, 38).addBox(-1.5F, -1.0F, -3.0F, 5.0F, 2.0F, 6.0F, 0.0F, false);
		...
		Body_r5.setPos(0.0F, 0.0F, 0.0F);
		swi2.addChild(Body_r5);
		setRotationAngle(Body_r5, -0.0873F, 0.0F, 0.0F);
		Body_r5.texOffs(64, 93).addBox(-2.0F, 3.5F, -1.5F, 4.0F, 23.0F, 1.0F, 0.0F, false);

		Body_r6 = new ModelRenderer(this);
		Body_r6.setPos(0.0F, 1.5197F, 0.4653F);
		swi2.addChild(Body_r6);
		setRotationAngle(Body_r6, -0.3491F, 0.0F, 0.0F);
		Body_r6.texOffs(66, 85).addBox(-2.0F, -2.5F, -1.5F, 4.0F, 5.0F, 1.0F, 0.0F, false);
		...
		Body_r7.setPos(0.0F, 2.0F, 0.0F);
		swi.addChild(Body_r7);
		setRotationAngle(Body_r7, -0.3491F, 0.0F, 0.0F);
		Body_r7.texOffs(65, 84).addBox(-2.0F, -2.5F, -1.5F, 4.0F, 5.0F, 1.0F, 0.0F, true);

		Body_r8 = new ModelRenderer(this);
		Body_r8.setPos(0.0F, 0.4803F, -0.4653F);
		swi.addChild(Body_r8);
		setRotationAngle(Body_r8, -0.0873F, 0.0F, 0.0F);
		Body_r8.texOffs(64, 93).addBox(-2.0F, 3.5F, -1.5F, 4.0F, 23.0F, 1.0F, 0.0F, true);
		...
		Body_r9.setPos(0.0F, 0.0F, 0.0F);
		cir.addChild(Body_r9);
		setRotationAngle(Body_r9, 0.0F, 0.0F, 1.0472F);
		Body_r9.texOffs(44, 0).addBox(-3.5F, -0.5F, -0.5F, 2.0F, 1.0F, 1.0F, 0.0F, true);

		Body_r10 = new ModelRenderer(this);
		Body_r10.setPos(0.3784F, -0.7999F, 0.0F);
		cir.addChild(Body_r10);
		setRotationAngle(Body_r10, 0.0F, 0.0F, 0.48F);
		Body_r10.texOffs(44, 0).addBox(-1.5F, -0.5F, -0.5F, 2.0F, 1.0F, 1.0F, 0.0F, true);

		Body_r11 = new ModelRenderer(this);
		Body_r11.setPos(2.3319F, -8.1397F, -4.5F);
		cir.addChild(Body_r11);
		setRotationAngle(Body_r11, 0.0F, 0.0F, -3.098F);
		Body_r11.texOffs(44, 0).addBox(-0.5F, -8.0F, 4.0F, 2.0F, 1.0F, 1.0F, 0.0F, true);

		Body_r12 = new ModelRenderer(this);
		Body_r12.setPos(2.6951F, -0.7999F, 0.0F);
		cir.addChild(Body_r12);
		setRotationAngle(Body_r12, 0.0F, 0.0F, -0.48F);
		Body_r12.texOffs(44, 0).addBox(-0.5F, -0.5F, -0.5F, 2.0F, 1.0F, 1.0F, 0.0F, false);

		Body_r13 = new ModelRenderer(this);
		Body_r13.setPos(3.0734F, 0.0F, 0.0F);
		cir.addChild(Body_r13);
		setRotationAngle(Body_r13, 0.0F, 0.0F, -1.0472F);
		Body_r13.texOffs(44, 0).addBox(1.5F, -0.5F, -0.5F, 2.0F, 1.0F, 1.0F, 0.0F, false);

		Body_r14 = new ModelRenderer(this);
		Body_r14.setPos(4.7565F, 0.7189F, 0.0F);
		cir.addChild(Body_r14);
		setRotationAngle(Body_r14, 0.0F, 0.0F, -1.5708F);
		Body_r14.texOffs(44, 0).addBox(3.5F, -0.5F, -0.5F, 2.0F, 1.0F, 1.0F, 0.0F, false);

		Body_r15 = new ModelRenderer(this);
		Body_r15.setPos(3.5065F, -7.8122F, -4.5F);
		cir.addChild(Body_r15);
		setRotationAngle(Body_r15, 0.0F, 0.0F, -2.0944F);
		Body_r15.texOffs(44, 0).addBox(-3.5F, -1.0F, 4.0F, 2.0F, 1.0F, 1.0F, 0.0F, false);

		Body_r16 = new ModelRenderer(this);
		Body_r16.setPos(2.9574F, -7.2631F, -4.5F);
		cir.addChild(Body_r16);
		setRotationAngle(Body_r16, 0.0F, 0.0F, -2.618F);
		Body_r16.texOffs(44, 0).addBox(-1.5F, -1.0F, 4.0F, 2.0F, 1.0F, 1.0F, 0.0F, false);

		Body_r17 = new ModelRenderer(this);
		Body_r17.setPos(-0.433F, -7.8122F, -4.5F);
		cir.addChild(Body_r17);
		setRotationAngle(Body_r17, 0.0F, 0.0F, 2.0944F);
		Body_r17.texOffs(44, 0).addBox(1.5F, -1.0F, 4.0F, 2.0F, 1.0F, 1.0F, 0.0F, true);

		Body_r18 = new ModelRenderer(this);
		Body_r18.setPos(-1.683F, 0.7189F, 0.0F);
		cir.addChild(Body_r18);
		setRotationAngle(Body_r18, 0.0F, 0.0F, 1.5708F);
		Body_r18.texOffs(44, 0).addBox(-5.5F, -0.5F, -0.5F, 2.0F, 1.0F, 1.0F, 0.0F, true);

		Body_r19 = new ModelRenderer(this);
		Body_r19.setPos(0.116F, -7.2631F, -4.5F);
		cir.addChild(Body_r19);
		setRotationAngle(Body_r19, 0.0F, 0.0F, 2.618F);
		Body_r19.texOffs(44, 0).addBox(-0.5F, -1.0F, 4.0F, 2.0F, 1.0F, 1.0F, 0.0F, true);

		Body_r20 = new ModelRenderer(this);
		Body_r20.setPos(1.3292F, -1.8856F, 0.0F);
		cir.addChild(Body_r20);
		setRotationAngle(Body_r20, 0.0F, 0.0F, 0.3491F);
		Body_r20.texOffs(41, 125).addBox(0.0F, -0.5F, -0.5F, 1.0F, 0.0F, 1.0F, 0.0F, true);

		Body_r21 = new ModelRenderer(this);
		Body_r21.setPos(1.961F, -5.7573F, 0.0F);
		cir.addChild(Body_r21);
		setRotationAngle(Body_r21, 0.0F, 0.0F, 0.7418F);
		Body_r21.texOffs(47, 3).addBox(-2.0F, 2.0F, -0.5F, 2.0F, 0.0F, 1.0F, 0.0F, false);

		Body_r22 = new ModelRenderer(this);
		Body_r22.setPos(1.1124F, -5.7573F, 0.0F);
		cir.addChild(Body_r22);
		setRotationAngle(Body_r22, 0.0F, 0.0F, -0.7418F);
		Body_r22.texOffs(47, 3).addBox(0.0F, 2.0F, -0.5F, 2.0F, 0.0F, 1.0F, 0.0F, true);

		Body_r23 = new ModelRenderer(this);
		Body_r23.setPos(1.1124F, -5.7573F, 0.0F);
		cir.addChild(Body_r23);
		setRotationAngle(Body_r23, 0.0F, 0.0F, -1.1345F);
		Body_r23.texOffs(47, 3).addBox(-1.0F, 1.0F, -0.5F, 2.0F, 0.0F, 1.0F, 0.0F, true);

		Body_r24 = new ModelRenderer(this);
		Body_r24.setPos(0.9903F, -1.2868F, 0.0F);
		cir.addChild(Body_r24);
		setRotationAngle(Body_r24, 0.0F, 0.0F, -2.0071F);
		Body_r24.texOffs(47, 3).addBox(3.0F, 2.0F, -0.5F, 2.0F, 0.0F, 1.0F, 0.0F, true);
		Body_r24.texOffs(41, 125).addBox(-1.0F, 2.0F, -0.5F, 2.0F, 0.0F, 1.0F, 0.0F, true);

		Body_r25 = new ModelRenderer(this);
		Body_r25.setPos(-0.3647F, -2.3793F, 0.0F);
		cir.addChild(Body_r25);
		setRotationAngle(Body_r25, 0.0F, 0.0F, -0.8727F);
		Body_r25.texOffs(41, 125).addBox(-1.0F, 2.0F, -0.5F, 2.0F, 0.0F, 1.0F, 0.0F, true);

		Body_r26 = new ModelRenderer(this);
		Body_r26.setPos(5.0044F, -1.656F, -4.5F);
		cir.addChild(Body_r26);
		setRotationAngle(Body_r26, 0.0F, 0.0F, -0.6109F);
		Body_r26.texOffs(41, 125).addBox(-2.5F, -3.0F, 4.0F, 2.0F, 1.0F, 1.0F, 0.0F, true);

		Body_r27 = new ModelRenderer(this);
		Body_r27.setPos(4.8592F, -5.8811F, -4.5F);
		cir.addChild(Body_r27);
		setRotationAngle(Body_r27, 0.0F, 0.0F, -1.789F);
		Body_r27.texOffs(41, 125).addBox(-2.5F, -3.0F, 4.0F, 2.0F, 1.0F, 1.0F, 0.0F, true);

		Body_r28 = new ModelRenderer(this);
		Body_r28.setPos(2.3944F, -7.3819F, -4.5F);
		cir.addChild(Body_r28);
		setRotationAngle(Body_r28, 0.0F, 0.0F, -2.7489F);
		Body_r28.texOffs(41, 125).addBox(-0.5F, -4.0F, 4.0F, 2.0F, 1.0F, 1.0F, 0.0F, true);

		Body_r29 = new ModelRenderer(this);
		Body_r29.setPos(2.0249F, -7.5349F, -4.5F);
		cir.addChild(Body_r29);
		setRotationAngle(Body_r29, 0.0F, 0.0F, -2.7489F);
		Body_r29.texOffs(47, 0).addBox(-1.9F, -3.0F, 4.0F, 3.0F, 1.0F, 1.0F, 0.0F, true);

		Body_r30 = new ModelRenderer(this);
		Body_r30.setPos(2.0249F, -7.5349F, -4.5F);
		cir.addChild(Body_r30);
		setRotationAngle(Body_r30, 0.0F, 0.0F, -3.098F);
		Body_r30.texOffs(44, 0).addBox(-0.5F, -1.0F, 4.0F, 2.0F, 1.0F, 1.0F, 0.0F, true);
		...
		Body_r31.setPos(3.7403F, -1.2461F, 0.0F);
		circle.addChild(Body_r31);
		setRotationAngle(Body_r31, 0.0F, 0.0F, 3.0543F);
		Body_r31.texOffs(44, 0).addBox(1.5F, -1.0F, -1.0F, 3.0F, 2.0F, 1.0F, 0.0F, false);

		Body_r32 = new ModelRenderer(this);
		Body_r32.setPos(-5.4996F, -1.2461F, 0.0F);
		circle.addChild(Body_r32);
		setRotationAngle(Body_r32, 0.0F, 0.0F, -3.0543F);
		Body_r32.texOffs(44, 0).addBox(-5.5F, -1.0F, -1.0F, 3.0F, 2.0F, 1.0F, 0.0F, true);

		Body_r33 = new ModelRenderer(this);
		Body_r33.setPos(3.27F, -1.6594F, 0.0F);
		circle.addChild(Body_r33);
		setRotationAngle(Body_r33, 0.0F, 0.0F, 2.7053F);
		Body_r33.texOffs(44, 0).addBox(-1.5F, -1.0F, -1.0F, 3.0F, 2.0F, 1.0F, 0.0F, false);

		Body_r34 = new ModelRenderer(this);
		Body_r34.setPos(1.1203F, -5.3609F, 0.0F);
		circle.addChild(Body_r34);
		setRotationAngle(Body_r34, 0.0F, 0.0F, -0.9599F);
		Body_r34.texOffs(44, 0).addBox(-1.0F, 3.5F, -1.0F, 6.0F, 2.0F, 1.0F, 0.0F, false);

		Body_r35 = new ModelRenderer(this);
		Body_r35.setPos(7.6254F, -9.3427F, 0.0F);
		circle.addChild(Body_r35);
		setRotationAngle(Body_r35, 0.0F, 0.0F, -1.5272F);
		Body_r35.texOffs(44, 0).addBox(-3.0F, -1.0F, -1.0F, 3.0F, 2.0F, 1.0F, 0.0F, false);

		Body_r36 = new ModelRenderer(this);
		Body_r36.setPos(5.2466F, -4.7737F, -0.5F);
		circle.addChild(Body_r36);
		setRotationAngle(Body_r36, 0.0F, 0.0F, 0.6981F);
		Body_r36.texOffs(44, 0).addBox(-3.0F, 0.5F, -0.5F, 4.0F, 1.0F, 1.0F, 0.0F, false);

		Body_r37 = new ModelRenderer(this);
		Body_r37.setPos(5.9307F, -6.6531F, -0.5F);
		circle.addChild(Body_r37);
		setRotationAngle(Body_r37, 0.0F, 0.0F, 0.3491F);
		Body_r37.texOffs(44, 0).addBox(-3.0F, -0.5F, -0.5F, 4.0F, 1.0F, 1.0F, 0.0F, false);

		Body_r38 = new ModelRenderer(this);
		Body_r38.setPos(2.7341F, -11.7797F, -5.0F);
		circle.addChild(Body_r38);
		setRotationAngle(Body_r38, 0.0F, 0.0F, -0.1309F);
		Body_r38.texOffs(44, 0).addBox(0.5F, 2.0F, 4.0F, 3.0F, 1.0F, 1.0F, 0.0F, false);

		Body_r39 = new ModelRenderer(this);
		Body_r39.setPos(2.7341F, -11.7797F, -5.0F);
		circle.addChild(Body_r39);
		setRotationAngle(Body_r39, 0.0F, 0.0F, -0.9599F);
		Body_r39.texOffs(44, 0).addBox(-0.5F, 0.0F, 4.0F, 3.0F, 1.0F, 1.0F, 0.0F, false);

		Body_r40 = new ModelRenderer(this);
		Body_r40.setPos(-5.0059F, -4.7737F, -0.5F);
		circle.addChild(Body_r40);
		setRotationAngle(Body_r40, 0.0F, 0.0F, -0.6981F);
		Body_r40.texOffs(44, 0).addBox(-2.0F, 0.5F, -0.5F, 4.0F, 1.0F, 1.0F, 0.0F, true);

		Body_r41 = new ModelRenderer(this);
		Body_r41.setPos(-5.69F, -6.6531F, -0.5F);
		circle.addChild(Body_r41);
		setRotationAngle(Body_r41, 0.0F, 0.0F, -0.3491F);
		Body_r41.texOffs(44, 0).addBox(-2.0F, -0.5F, -0.5F, 4.0F, 1.0F, 1.0F, 0.0F, true);

		Body_r42 = new ModelRenderer(this);
		Body_r42.setPos(-2.4935F, -11.7797F, -5.0F);
		circle.addChild(Body_r42);
		setRotationAngle(Body_r42, 0.0F, 0.0F, 0.1309F);
		Body_r42.texOffs(44, 0).addBox(-4.5F, 2.0F, 4.0F, 4.0F, 1.0F, 1.0F, 0.0F, true);

		Body_r43 = new ModelRenderer(this);
		Body_r43.setPos(-2.4935F, -11.7797F, -5.0F);
		circle.addChild(Body_r43);
		setRotationAngle(Body_r43, 0.0F, 0.0F, 0.9599F);
		Body_r43.texOffs(44, 0).addBox(-3.5F, 1.0F, 4.0F, 4.0F, 1.0F, 1.0F, 0.0F, true);

		Body_r44 = new ModelRenderer(this);
		Body_r44.setPos(-0.5532F, -12.1868F, -5.0F);
		circle.addChild(Body_r44);
		setRotationAngle(Body_r44, 0.0F, 0.0F, 3.0107F);
		Body_r44.texOffs(44, 0).addBox(-0.5F, -1.0F, 4.0F, 2.0F, 1.0F, 1.0F, 0.0F, true);

		Body_r45 = new ModelRenderer(this);
		Body_r45.setPos(-8.6239F, -8.1063F, 0.0F);
		circle.addChild(Body_r45);
		setRotationAngle(Body_r45, 0.0F, 0.0F, 1.789F);
		Body_r45.texOffs(44, 0).addBox(-4.0F, -5.0F, -1.0F, 2.0F, 1.0F, 1.0F, 0.0F, true);
		Body_r45.texOffs(44, 0).addBox(-4.0F, -1.0F, -1.0F, 3.0F, 2.0F, 1.0F, 0.0F, true);

		Body_r46 = new ModelRenderer(this);
		Body_r46.setPos(4.1591F, -7.6553F, -0.5F);
		circle.addChild(Body_r46);
		setRotationAngle(Body_r46, 0.0F, 0.0F, -1.6581F);
		Body_r46.texOffs(44, 0).addBox(-0.5F, -1.5F, -0.5F, 2.0F, 1.0F, 1.0F, 0.0F, false);

		Body_r47 = new ModelRenderer(this);
		Body_r47.setPos(-3.9185F, -7.6553F, -0.5F);
		circle.addChild(Body_r47);
		setRotationAngle(Body_r47, 0.0F, 0.0F, 1.6581F);
		Body_r47.texOffs(44, 0).addBox(-1.5F, -0.5F, -0.5F, 2.0F, 1.0F, 1.0F, 0.0F, true);

		Body_r48 = new ModelRenderer(this);
		Body_r48.setPos(-3.5549F, -6.5447F, -0.5F);
		circle.addChild(Body_r48);
		setRotationAngle(Body_r48, 0.0F, 0.0F, 1.0908F);
		Body_r48.texOffs(44, 0).addBox(-1.0F, -0.5F, -0.5F, 2.0F, 1.0F, 1.0F, 0.0F, true);

		Body_r49 = new ModelRenderer(this);
		Body_r49.setPos(2.7955F, -6.5447F, -0.5F);
		circle.addChild(Body_r49);
		setRotationAngle(Body_r49, 0.0F, 0.0F, -1.0908F);
		Body_r49.texOffs(44, 0).addBox(-1.0F, -0.5F, -0.5F, 2.0F, 1.0F, 1.0F, 0.0F, false);

		Body_r50 = new ModelRenderer(this);
		Body_r50.setPos(7.8646F, -8.1063F, 0.0F);
		circle.addChild(Body_r50);
		setRotationAngle(Body_r50, 0.0F, 0.0F, -1.789F);
		Body_r50.texOffs(44, 0).addBox(2.0F, -5.0F, -1.0F, 2.0F, 1.0F, 1.0F, 0.0F, false);
		Body_r50.texOffs(44, 0).addBox(1.0F, -1.0F, -1.0F, 3.0F, 2.0F, 1.0F, 0.0F, false);

		Body_r51 = new ModelRenderer(this);
		Body_r51.setPos(3.7365F, -12.413F, 0.0F);
		circle.addChild(Body_r51);
		setRotationAngle(Body_r51, 0.0F, 0.0F, -2.3126F);
		Body_r51.texOffs(46, 0).addBox(-3.0F, 1.0F, -1.0F, 6.0F, 2.0F, 1.0F, 0.0F, false);

		Body_r52 = new ModelRenderer(this);
		Body_r52.setPos(-0.4869F, -16.7504F, -1.0F);
		circle.addChild(Body_r52);
		setRotationAngle(Body_r52, 0.0F, 0.0F, -2.4435F);
		Body_r52.texOffs(44, 0).addBox(-1.5F, -3.2F, 0.0F, 4.0F, 1.0F, 1.0F, 0.0F, true);

		Body_r53 = new ModelRenderer(this);
		Body_r53.setPos(0.7276F, -16.7504F, -1.0F);
		circle.addChild(Body_r53);
		setRotationAngle(Body_r53, 0.0F, 0.0F, 2.4435F);
		Body_r53.texOffs(44, 0).addBox(-1.5F, -2.2F, 0.0F, 4.0F, 1.0F, 1.0F, 0.0F, false);

		Body_r54 = new ModelRenderer(this);
		Body_r54.setPos(-0.5073F, -16.301F, -1.0F);
		circle.addChild(Body_r54);
		setRotationAngle(Body_r54, 0.0F, 0.0F, -2.3562F);
		Body_r54.texOffs(0, 0).addBox(-1.7F, -2.2F, -1.0F, 2.0F, 2.0F, 1.0F, 0.0F, false);

		Body_r55 = new ModelRenderer(this);
		Body_r55.setPos(-0.5073F, -16.301F, -1.0F);
		circle.addChild(Body_r55);
		setRotationAngle(Body_r55, 0.0F, 0.0F, -3.1416F);
		Body_r55.texOffs(114, 2).addBox(-3.0723F, -11.2F, 0.0F, 6.0F, 6.0F, 1.0F, 0.0F, false);
		Body_r55.texOffs(44, 0).addBox(-1.5F, -4.2F, 0.0F, 3.0F, 2.0F, 1.0F, 0.0F, false);
		Body_r55.texOffs(44, 0).addBox(-1.5F, -1.0F, 0.0F, 3.0F, 3.0F, 1.0F, 0.0F, false);

		Body_r56 = new ModelRenderer(this);
		Body_r56.setPos(-0.2062F, -12.1868F, -5.0F);
		circle.addChild(Body_r56);
		setRotationAngle(Body_r56, 0.0F, 0.0F, -3.0107F);
		Body_r56.texOffs(44, 0).addBox(-1.5F, -1.0F, 4.0F, 2.0F, 1.0F, 1.0F, 0.0F, false);

		Body_r57 = new ModelRenderer(this);
		Body_r57.setPos(2.2407F, -16.0F, 0.0F);
		circle.addChild(Body_r57);
		setRotationAngle(Body_r57, 0.0F, 0.0F, -2.9234F);
		Body_r57.texOffs(44, 0).addBox(-1.5F, -1.0F, -1.0F, 3.0F, 2.0F, 1.0F, 0.0F, false);

		Body_r58 = new ModelRenderer(this);
		Body_r58.setPos(-4.4958F, -12.413F, 0.0F);
		circle.addChild(Body_r58);
		setRotationAngle(Body_r58, 0.0F, 0.0F, 2.3126F);
		Body_r58.texOffs(44, 0).addBox(-3.0F, 1.0F, -1.0F, 6.0F, 2.0F, 1.0F, 0.0F, true);

		Body_r59 = new ModelRenderer(this);
		Body_r59.setPos(-4.0293F, -1.6594F, 0.0F);
		circle.addChild(Body_r59);
		setRotationAngle(Body_r59, 0.0F, 0.0F, -2.7053F);
		Body_r59.texOffs(44, 0).addBox(-1.5F, -1.0F, -1.0F, 3.0F, 2.0F, 1.0F, 0.0F, true);

		Body_r60 = new ModelRenderer(this);
		Body_r60.setPos(-8.3847F, -9.3427F, 0.0F);
		circle.addChild(Body_r60);
		setRotationAngle(Body_r60, 0.0F, 0.0F, 1.5272F);
		Body_r60.texOffs(44, 0).addBox(0.0F, -1.0F, -1.0F, 3.0F, 2.0F, 1.0F, 0.0F, true);

		Body_r61 = new ModelRenderer(this);
		Body_r61.setPos(-1.8797F, -5.3609F, 0.0F);
		circle.addChild(Body_r61);
		setRotationAngle(Body_r61, 0.0F, 0.0F, 0.9599F);
		Body_r61.texOffs(44, 0).addBox(-5.0F, 3.5F, -1.0F, 6.0F, 2.0F, 1.0F, 0.0F, true);

		Body_r62 = new ModelRenderer(this);
		Body_r62.setPos(-3.0F, -16.0F, 0.0F);
		circle.addChild(Body_r62);
		setRotationAngle(Body_r62, 0.0F, 0.0F, 2.9234F);
		Body_r62.texOffs(44, 0).addBox(-1.5F, -1.0F, -1.0F, 3.0F, 2.0F, 1.0F, 0.0F, true);
		...
		RightArm.setPos(-9.0F, -37.0F, -1.0F);
		...
		LeftArm.setPos(8.4442F, -34.8343F, -0.4302F);
