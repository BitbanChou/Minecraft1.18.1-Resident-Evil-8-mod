...
public class HeisenBoots extends BipedModel {
	...
	public HeisenBoots() {
		...
		RightLeg.setPos(-4.8F, 12.0F, 0.0F);
...
//        armorLeftBoot.showModel = false;
	...
	public final HeisenBoots applyEntityStats(BipedModel defaultArmor){
