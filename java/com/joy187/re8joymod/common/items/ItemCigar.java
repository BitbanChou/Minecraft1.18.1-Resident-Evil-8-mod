...
public class ItemCigar extends Item {
    public ItemCigar() {
        super(new Item.Properties().tab(RegistryEvents.RE8GROUP).stacksTo(1));
    }
    ...
    public ActionResultType useOn(ItemUseContext p_195939_1_) {
        ...
        if (CampfireBlock.canLight(blockstate)) {
            ...
            if (playerentity != null) {
                p_195939_1_.getItemInHand().hurtAndBreak(0, playerentity, (p_219999_1_) -> {
            ...
            if (AbstractFireBlock.canBePlacedAt(world, blockpos1, p_195939_1_.getHorizontalDirection())) {
                ...
                if (playerentity instanceof ServerPlayerEntity) {
                    ...
                    itemstack.hurtAndBreak(0, playerentity, (p_219998_1_) -> {
