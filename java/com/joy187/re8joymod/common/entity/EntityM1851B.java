...
public class EntityM1851B extends ProjectileItemEntity {
    public int explosionPower = 1,id=91087;
    //    protected UUID uuid = MathHelper.createInsecureUUID(this.random);
    public Entity shootingEntity;
    private double damage;

    public EntityM1851B(EntityType<? extends EntityM1851B> p_i50159_1_, World p_i50159_2_) {
...
//    }
    ...
    public EntityM1851B(World world, LivingEntity entity) {
        super(EntityInit.M1851B.get(), entity, world);
        this.damage=18;
    }

    public EntityM1851B(World p_i1775_1_, double p_i1775_2_, double p_i1775_4_, double p_i1775_6_) {
        super(EntityInit.M1851B.get(), p_i1775_2_, p_i1775_4_, p_i1775_6_, p_i1775_1_);
    }
