...
public class EntityEndScienceBlack extends VillagerEntity {
    public EntityEndScienceBlack(EntityType<? extends VillagerEntity> p_35381_, World p_35382_) {
    ...
    public static final RegistryObject<PointOfInterestType> VIRUS_POI = POI_TYPES.register("edman_poi4",
            () -> new PointOfInterestType("edman_poi4",
                    PointOfInterestType.getBlockStates(Blocks.OBSIDIAN), 1, 1));

    public static final RegistryObject<VillagerProfession> EDMANGUARD3 =
            VILLAGER_PROFESSIONS.register("edman.science",
                    () -> new VillagerProfession("edman.science", VIRUS_POI.get(),
