...
public class EntityEndKing extends VillagerEntity {
    public EntityEndKing(EntityType<? extends VillagerEntity> p_35381_, World p_35382_) {
    ...
    public static final RegistryObject<PointOfInterestType> VIRUS_POI = POI_TYPES.register("edman_poi3",
            () -> new PointOfInterestType("edman_poi3",
                    PointOfInterestType.getBlockStates(Blocks.BEACON), 1, 1));

    public static final RegistryObject<VillagerProfession> EDMANGUARD2 =
            VILLAGER_PROFESSIONS.register("edman.king",
                    () -> new VillagerProfession("edman.king", VIRUS_POI.get(),
