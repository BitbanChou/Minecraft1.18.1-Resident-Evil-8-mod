...
public class RenderBOWShoot extends EntityRenderer<EntityBOWShoot> {
    ...
    public RenderBOWShoot(EntityRendererManager manager) {
        super(manager);
    }

    protected int getSkyLightLevel(EntityBOWShoot p_239381_1_, BlockPos p_239381_2_) {
        return 15;
    }


    public void render(EntityBOWShoot entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
...
//        matrixStackIn.(Vector3f.YP.rotationDegrees(180.0F));
    ...
    @Override
    public ResourceLocation getTextureLocation(EntityBOWShoot  p_110775_1_) {
        return TEXTURE;
    }
    ...
    public static class RenderFactory implements IRenderFactory<EntityBOWShoot> {

        @Override
        public EntityRenderer<? super EntityBOWShoot> createRenderFor(EntityRendererManager manager) {
            manager.setRenderShadow(false);
            return new RenderBOWShoot(manager);
        }
    }
