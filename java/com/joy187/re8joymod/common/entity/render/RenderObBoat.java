...
import com.joy187.re8joymod.common.entity.model.ModelObBoat;
...
//@OnlyIn(Dist.CLIENT)
public class RenderObBoat extends EntityRenderer<EntityObBoat> {
    ...
    public static final ResourceLocation BOAT_TEXTURE_LOCATIONS = new ResourceLocation(Utils.MOD_ID, "textures/entity/obboat.png");

    protected final ModelObBoat model;// = new ModelObBoat();

    public RenderObBoat(EntityRendererManager p_i46190_1_) {
        super(p_i46190_1_);
        this.model=new ModelObBoat();
        this.shadowRadius = 0.8F;
    }

    public void render(EntityObBoat p_225623_1_, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
    ...
    public ResourceLocation getTextureLocation(EntityObBoat p_110775_1_) {
