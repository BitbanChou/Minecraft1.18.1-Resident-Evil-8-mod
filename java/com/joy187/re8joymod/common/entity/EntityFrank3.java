...
public class EntityFrank3 extends EntityFrank1{
    public EntityFrank3(EntityType<? extends MonsterEntity> type, World worldIn) {
        super(type, worldIn);
        this.xpReward = 25;
    }
    ...
    public static AttributeModifierMap.MutableAttribute setAttributes() {
        return MobEntity.createMobAttributes().add(Attributes.MAX_HEALTH, 40.0D).
                ...
                add(Attributes.ARMOR_TOUGHNESS, 4.1D).
