...
public class EntityAxeman extends RavagerEntity {


    public EntityAxeman(EntityType<? extends RavagerEntity> type, World worldIn) {
        super(type, worldIn);
        this.xpReward = 70;
    ...
    public void aiStep() {
        ...
        if(co==1)
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                this.level.addParticle(ParticleTypes.ASH, pos.x, pos.y, pos.z, 0,0,0);
            }
        }
        else if(co==2)
        {
        ...
        if (this.isAlive()) {
            if (this.isImmobile()) {
                ...
                double d0 = this.getTarget() != null ? 0.23D : 0.26D;
    ...
    public boolean doHurtTarget(Entity p_70652_1_) {
        ...
        if (flag && this.getMainHandItem().isEmpty() && p_70652_1_ instanceof LivingEntity) {
            ...
            ((LivingEntity)p_70652_1_).addEffect(new EffectInstance(ModEffects.BURN.get(), 100 * (int)f));
        }
