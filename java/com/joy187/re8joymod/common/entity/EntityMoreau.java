...
public class EntityMoreau extends RavagerEntity {
    ...
    public EntityMoreau(EntityType<? extends RavagerEntity> type, World worldIn) {
        super(type, worldIn);
        this.xpReward = 80;
        this.isNonBoss();
    }
...
//        this.targetSelector.addGoal(1, new NearestAttackableTargetGoal<>(this, Entity.class, true));
    ...
    public boolean doHurtTarget(Entity entityIn) {
        if(!super.doHurtTarget(entityIn))
        {
            ...
            if(entityIn instanceof LivingEntity)
            {
                ...
                ((LivingEntity)entityIn).addEffect(new EffectInstance(Effects.CONFUSION, 100,2,true,true));
    ...
    protected void customServerAiStep() {
        ...
        {
            EntityMoreau2 e = new EntityMoreau2(EntityInit.MOREAU2.get(),this.level);
            e.copyPosition(this);
