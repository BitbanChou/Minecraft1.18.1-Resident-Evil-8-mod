...
public class ModelMia<T extends EntityMia> extends EntityModel<T> {
	...
	public ModelMia() {
		...
		RightLeg_r1.texOffs(16, 53).addBox(-2.0F, 0.0F, -3.0F, 4.0F, 7.0F, 4.0F, 0.0F, false);
		...
		LeftLeg_r1.texOffs(17, 53).addBox(-2.0F, 0.0F, -3.0F, 4.0F, 8.0F, 3.0F, 0.0F, false);
