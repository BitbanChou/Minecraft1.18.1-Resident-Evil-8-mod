...
public class ModelEndGuard<T extends EntityEndGuard>  extends EntityModel<T>  {
	...
	public ModelEndGuard() {
		texWidth = 64;
		texHeight = 64;

		body = new ModelRenderer(this);
		body.setPos(0.0F, -15.0F, 0.0F);
		body.texOffs(28, 29).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 15.0F, 4.0F, 0.0F, false);
