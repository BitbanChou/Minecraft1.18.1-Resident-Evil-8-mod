...
public class ModelDund2<T extends EntityDund2> extends EntityModel<T> {
	...
	public ModelDund2() {
		...
		RightArm_r2.setPos(0.0F, 1.1563F, -7.6182F);
		knife.addChild(RightArm_r2);
		setRotationAngle(RightArm_r2, -0.2182F, 0.0F, 0.0F);
		RightArm_r2.texOffs(16, 54).addBox(-0.5F, -0.5F, -9.0F, 1.0F, 1.0F, 9.0F, 0.0F, false);

		RightArm_r3 = new ModelRenderer(this);
		RightArm_r3.setPos(0.0F, -1.1294F, -16.7735F);
		knife.addChild(RightArm_r3);
		setRotationAngle(RightArm_r3, 0.3054F, 0.0F, 0.0F);
		RightArm_r3.texOffs(38, 35).addBox(-0.5F, 0.0F, -0.5F, 1.0F, 0.0F, 1.0F, 0.0F, false);

		RightArm_r4 = new ModelRenderer(this);
		RightArm_r4.setPos(-0.1429F, -1.7738F, -16.095F);
		knife.addChild(RightArm_r4);
		setRotationAngle(RightArm_r4, 0.0F, -0.2618F, -1.5272F);
		RightArm_r4.texOffs(38, 35).addBox(-1.5F, 0.1F, -0.5F, 1.0F, 0.0F, 1.0F, 0.0F, false);

		RightArm_r5 = new ModelRenderer(this);
		RightArm_r5.setPos(0.0F, -1.0099F, -16.4822F);
		knife.addChild(RightArm_r5);
		setRotationAngle(RightArm_r5, -0.829F, 0.0F, 0.0F);
		RightArm_r5.texOffs(38, 35).addBox(-0.5F, 0.5F, -0.5F, 1.0F, 0.0F, 1.0F, 0.0F, false);

		RightArm_r6 = new ModelRenderer(this);
		RightArm_r6.setPos(0.0891F, -0.1551F, -7.0337F);
		knife.addChild(RightArm_r6);
		setRotationAngle(RightArm_r6, 1.5708F, 0.0F, 0.0873F);
		RightArm_r6.texOffs(19, 53).addBox(-0.5F, -0.6F, -1.8814F, 1.0F, 1.0F, 2.0F, 0.0F, false);

		RightArm_r7 = new ModelRenderer(this);
		RightArm_r7.setPos(-0.1747F, 2.8599F, -8.6296F);
		knife.addChild(RightArm_r7);
		setRotationAngle(RightArm_r7, 1.1781F, 0.0F, 0.0873F);
		RightArm_r7.texOffs(19, 53).addBox(-0.5F, 0.5F, 0.5F, 1.0F, 1.0F, 2.0F, 0.0F, false);

		RightArm_r8 = new ModelRenderer(this);
		RightArm_r8.setPos(0.0F, 1.0F, -3.0F);
		knife.addChild(RightArm_r8);
		setRotationAngle(RightArm_r8, -0.1745F, 0.0F, 0.0F);
		RightArm_r8.texOffs(34, 41).addBox(-0.5F, 0.5F, -3.5F, 1.0F, 1.0F, 6.0F, 0.0F, false);
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
		...
		this.RightArm.xRot = MathHelper.cos(limbSwing * 0.7662F + (float)Math.PI) * 1.1F * limbSwingAmount;
