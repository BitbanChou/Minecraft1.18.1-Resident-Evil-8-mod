...
public class ModelMoreau4<T extends EntityMoreau4> extends EntityModel<T> {
	...
	private final ModelRenderer bottle2_r3;
	...
	public ModelMoreau4() {
		...
		Body_r1.setPos(1.6973F, -1.8708F, -9.1161F);
		Body.addChild(Body_r1);
		setRotationAngle(Body_r1, 0.2179F, 0.8112F, -1.5166F);
		Body_r1.texOffs(18, 12).addBox(-0.2324F, -7.8915F, -8.0016F, 3.0F, 10.0F, 17.0F, 0.0F, false);

		Body_r2 = new ModelRenderer(this);
		Body_r2.setPos(6.6973F, 2.1292F, -11.1161F);
		Body.addChild(Body_r2);
		setRotationAngle(Body_r2, 0.2014F, 0.5497F, -0.3925F);
		Body_r2.texOffs(18, 12).addBox(-0.2324F, -7.8915F, -8.0016F, 3.0F, 10.0F, 17.0F, 0.0F, false);

		Body_r3 = new ModelRenderer(this);
		Body_r3.setPos(5.5959F, 12.0421F, -8.2868F);
		Body.addChild(Body_r3);
		setRotationAngle(Body_r3, -0.5304F, 0.1496F, -1.3718F);
		Body_r3.texOffs(18, 23).addBox(-2.3059F, 0.8552F, -5.8216F, 8.0F, 3.0F, 13.0F, 0.0F, false);

		Body_r4 = new ModelRenderer(this);
		Body_r4.setPos(5.5959F, 12.0421F, -8.2868F);
		Body.addChild(Body_r4);
		setRotationAngle(Body_r4, -0.5185F, -0.0935F, -0.9568F);
		Body_r4.texOffs(18, 23).addBox(-5.4811F, 1.1962F, -5.231F, 8.0F, 3.0F, 13.0F, 0.0F, false);

		Body_r5 = new ModelRenderer(this);
		Body_r5.setPos(-4.2095F, 11.64F, -6.9824F);
		Body.addChild(Body_r5);
		setRotationAngle(Body_r5, 0.011F, -0.8286F, 0.3867F);
		Body_r5.texOffs(18, 23).addBox(-1.7271F, 2.2292F, -5.3925F, 8.0F, 3.0F, 13.0F, 0.0F, false);

		Body_r6 = new ModelRenderer(this);
		Body_r6.setPos(-4.2095F, 11.64F, -6.9824F);
		Body.addChild(Body_r6);
		setRotationAngle(Body_r6, -0.3567F, -0.5318F, 1.346F);
		Body_r6.texOffs(18, 23).addBox(-5.3743F, 0.2401F, -6.4819F, 8.0F, 3.0F, 13.0F, 0.0F, false);

		Body_r7 = new ModelRenderer(this);
		Body_r7.setPos(1.6973F, -1.8708F, -9.1161F);
		Body.addChild(Body_r7);
		setRotationAngle(Body_r7, 0.6904F, 0.0734F, 0.2976F);
		Body_r7.texOffs(18, 23).addBox(-2.2777F, -3.7855F, -7.4234F, 8.0F, 3.0F, 16.0F, 0.0F, false);

		Body_r8 = new ModelRenderer(this);
		Body_r8.setPos(6.6973F, 2.1292F, -11.1161F);
		Body.addChild(Body_r8);
		setRotationAngle(Body_r8, 0.4376F, 0.147F, 1.4041F);
		Body_r8.texOffs(18, 23).addBox(-2.2777F, -3.7855F, -7.4234F, 8.0F, 3.0F, 16.0F, 0.0F, false);

		Body_r9 = new ModelRenderer(this);
		Body_r9.setPos(-6.0955F, 1.0612F, -8.7486F);
		Body.addChild(Body_r9);
		setRotationAngle(Body_r9, -0.6734F, 0.1526F, 1.5146F);
		Body_r9.texOffs(16, 22).addBox(-2.0229F, 0.2156F, -6.6246F, 8.0F, 3.0F, 16.0F, 0.0F, false);

		Body_r10 = new ModelRenderer(this);
		Body_r10.setPos(-6.0955F, 1.0612F, -8.7486F);
		Body.addChild(Body_r10);
		setRotationAngle(Body_r10, -0.461F, -0.2717F, 2.2846F);
		Body_r10.texOffs(18, 23).addBox(-5.9255F, 0.7501F, -3.5141F, 8.0F, 3.0F, 13.0F, 0.0F, false);

		Body_r11 = new ModelRenderer(this);
		Body_r11.setPos(-0.5F, 7.2141F, 5.8971F);
		Body.addChild(Body_r11);
		setRotationAngle(Body_r11, 0.5236F, 0.0F, 0.0F);
		Body_r11.texOffs(0, 35).addBox(-1.5F, -4.0F, -1.5F, 3.0F, 8.0F, 3.0F, 0.0F, false);

		Body_r12 = new ModelRenderer(this);
		Body_r12.setPos(0.0F, -4.0F, 5.5F);
		Body.addChild(Body_r12);
		setRotationAngle(Body_r12, 0.3491F, 0.0F, 0.0F);
		Body_r12.texOffs(42, 54).addBox(-3.0F, -5.0F, -17.5F, 6.0F, 5.0F, 5.0F, 0.0F, false);
		Body_r12.texOffs(12, 41).addBox(-6.0F, -7.0F, -9.5F, 12.0F, 9.0F, 14.0F, 0.0F, false);

		Body_r13 = new ModelRenderer(this);
		Body_r13.setPos(12.0F, -6.0F, 10.5F);
		Body.addChild(Body_r13);
		setRotationAngle(Body_r13, 0.0F, 0.1745F, -0.48F);
		Body_r13.texOffs(12, 29).addBox(-1.0F, -6.0F, -16.5F, 3.0F, 12.0F, 23.0F, 0.0F, true);

		Body_r14 = new ModelRenderer(this);
		Body_r14.setPos(-12.0F, -6.0F, 10.5F);
		Body.addChild(Body_r14);
		setRotationAngle(Body_r14, 0.0F, -0.1745F, 0.48F);
		Body_r14.texOffs(12, 29).addBox(-2.0F, -6.0F, -16.5F, 3.0F, 12.0F, 23.0F, 0.0F, false);

		Body_r15 = new ModelRenderer(this);
		Body_r15.setPos(8.3807F, 13.7163F, 9.0F);
		Body.addChild(Body_r15);
		setRotationAngle(Body_r15, 0.0F, 0.0F, 0.6545F);
		Body_r15.texOffs(0, 29).addBox(0.0F, -6.0F, -11.0F, 5.0F, 8.0F, 22.0F, 0.0F, true);

		Body_r16 = new ModelRenderer(this);
		Body_r16.setPos(-8.3807F, 13.7163F, 9.0F);
		Body.addChild(Body_r16);
		setRotationAngle(Body_r16, 0.0F, 0.0F, -0.6545F);
		Body_r16.texOffs(0, 29).addBox(-5.0F, -6.0F, -11.0F, 5.0F, 8.0F, 22.0F, 0.0F, false);

		Body_r17 = new ModelRenderer(this);
		Body_r17.setPos(7.0897F, 15.2773F, 9.0F);
		Body.addChild(Body_r17);
		setRotationAngle(Body_r17, 0.0F, 0.0F, 1.3963F);
		Body_r17.texOffs(0, 27).addBox(-3.0F, -6.0F, -11.0F, 6.0F, 15.0F, 22.0F, 0.0F, true);
		Body_r17.texOffs(12, 32).addBox(-3.0F, -3.0F, 7.0F, 4.0F, 10.0F, 22.0F, 0.0F, true);

		Body_r18 = new ModelRenderer(this);
		Body_r18.setPos(2.2121F, 21.993F, 55.785F);
		Body.addChild(Body_r18);
		setRotationAngle(Body_r18, 0.0F, -0.0436F, -1.6144F);
		Body_r18.texOffs(0, 29).addBox(8.0F, -5.0F, -2.0F, 7.0F, 10.0F, 18.0F, 0.0F, false);
		Body_r18.texOffs(0, 29).addBox(4.0F, -3.0F, 23.0F, 4.0F, 6.0F, 16.0F, 0.0F, false);
		Body_r18.texOffs(0, 29).addBox(4.0F, -5.0F, 7.0F, 4.0F, 10.0F, 16.0F, 0.0F, false);
		...
		Body_r19.setPos(-2.8773F, 12.7897F, 99.7652F);
		Body.addChild(Body_r19);
		setRotationAngle(Body_r19, 0.0F, 0.6981F, -2.2689F);
		Body_r19.texOffs(0, 29).addBox(-2.0F, -2.0F, -11.0F, 4.0F, 6.0F, 16.0F, 0.0F, false);

		Body_r20 = new ModelRenderer(this);
		Body_r20.setPos(2.2121F, 21.993F, 55.785F);
		Body.addChild(Body_r20);
		setRotationAngle(Body_r20, 0.0F, 0.2182F, -1.6144F);
		Body_r20.texOffs(0, 29).addBox(1.0F, -5.0F, -6.0F, 6.0F, 10.0F, 16.0F, 0.0F, false);

		Body_r21 = new ModelRenderer(this);
		Body_r21.setPos(1.989F, 16.8828F, 44.0F);
		Body.addChild(Body_r21);
		setRotationAngle(Body_r21, 0.0F, -0.2618F, -1.6144F);
		Body_r21.texOffs(0, 29).addBox(-2.0F, -5.0F, -11.0F, 4.0F, 10.0F, 17.0F, 0.0F, false);

		Body_r22 = new ModelRenderer(this);
		Body_r22.setPos(-7.0897F, 15.2773F, 9.0F);
		Body.addChild(Body_r22);
		setRotationAngle(Body_r22, 0.0F, 0.0F, -1.3963F);
		Body_r22.texOffs(0, 29).addBox(-1.0F, -3.0F, 7.0F, 4.0F, 10.0F, 22.0F, 0.0F, false);
		Body_r22.texOffs(0, 29).addBox(-3.0F, -6.0F, -11.0F, 6.0F, 12.0F, 22.0F, 0.0F, false);

		Body_r23 = new ModelRenderer(this);
		Body_r23.setPos(1.2275F, 4.0987F, 62.3715F);
		Body.addChild(Body_r23);
		setRotationAngle(Body_r23, 0.0436F, -0.3054F, -1.6144F);
		Body_r23.texOffs(7, 22).addBox(-7.0F, -4.5F, 9.0F, 6.0F, 11.0F, 17.0F, 0.0F, true);
		Body_r23.texOffs(7, 22).addBox(-5.0F, -4.5F, -7.0F, 8.0F, 11.0F, 17.0F, 0.0F, true);

		Body_r24 = new ModelRenderer(this);
		Body_r24.setPos(-0.5989F, -12.2009F, 25.6123F);
		Body.addChild(Body_r24);
		setRotationAngle(Body_r24, 0.0436F, -0.3054F, -1.789F);
		Body_r24.texOffs(11, 56).addBox(-0.5F, -0.5F, 24.0F, 4.0F, 3.0F, 5.0F, 0.0F, true);
		Body_r24.texOffs(11, 56).addBox(7.5F, -0.5F, 22.0F, 4.0F, 3.0F, 5.0F, 0.0F, true);
		Body_r24.texOffs(0, 47).addBox(1.5F, -0.5F, 13.0F, 6.0F, 3.0F, 14.0F, 0.0F, true);
		Body_r24.texOffs(7, 22).addBox(-5.5F, -5.5F, 11.0F, 6.0F, 11.0F, 20.0F, 0.0F, true);
		Body_r24.texOffs(0, 30).addBox(-3.5F, -6.5F, -10.0F, 5.0F, 13.0F, 21.0F, 0.0F, true);

		Body_r25 = new ModelRenderer(this);
		Body_r25.setPos(8.089F, -9.2031F, 25.7953F);
		Body.addChild(Body_r25);
		setRotationAngle(Body_r25, 0.2182F, -0.3491F, -0.9599F);
		Body_r25.texOffs(12, 35).addBox(-3.0F, -4.5F, -10.0F, 3.0F, 9.0F, 20.0F, 0.0F, true);

		Body_r26 = new ModelRenderer(this);
		Body_r26.setPos(-8.089F, -9.2031F, 25.7953F);
		Body.addChild(Body_r26);
		setRotationAngle(Body_r26, 0.2182F, 0.3491F, 0.9599F);
		Body_r26.texOffs(12, 35).addBox(0.0F, -4.5F, -10.0F, 3.0F, 9.0F, 20.0F, 0.0F, false);

		Body_r27 = new ModelRenderer(this);
		Body_r27.setPos(13.8543F, 5.3439F, 26.3663F);
		Body.addChild(Body_r27);
		setRotationAngle(Body_r27, -0.2618F, -0.2618F, 0.0F);
		Body_r27.texOffs(12, 35).addBox(-7.0F, -10.5F, -12.0F, 6.0F, 9.0F, 20.0F, 0.0F, true);

		Body_r28 = new ModelRenderer(this);
		Body_r28.setPos(-13.8543F, 5.3439F, 26.3663F);
		Body.addChild(Body_r28);
		setRotationAngle(Body_r28, -0.2618F, 0.2618F, 0.0F);
		Body_r28.texOffs(12, 35).addBox(1.0F, -10.5F, -12.0F, 6.0F, 9.0F, 20.0F, 0.0F, false);

		Body_r29 = new ModelRenderer(this);
		Body_r29.setPos(12.0F, 7.5F, 31.0F);
		Body.addChild(Body_r29);
		setRotationAngle(Body_r29, 0.0F, -0.2618F, 0.0F);
		Body_r29.texOffs(12, 35).addBox(-5.0F, -4.5F, -12.0F, 6.0F, 9.0F, 20.0F, 0.0F, true);

		Body_r30 = new ModelRenderer(this);
		Body_r30.setPos(4.2337F, 3.3197F, 50.3251F);
		Body.addChild(Body_r30);
		setRotationAngle(Body_r30, -0.0436F, -0.2618F, 0.0F);
		Body_r30.texOffs(10, 32).addBox(-4.5F, -7.5F, -15.0F, 7.0F, 12.0F, 20.0F, 0.0F, true);

		Body_r31 = new ModelRenderer(this);
		Body_r31.setPos(-4.2337F, 3.3197F, 50.3251F);
		Body.addChild(Body_r31);
		setRotationAngle(Body_r31, -0.0436F, 0.2618F, 0.0F);
		Body_r31.texOffs(10, 32).addBox(-2.5F, -7.5F, -15.0F, 7.0F, 12.0F, 20.0F, 0.0F, false);

		Body_r32 = new ModelRenderer(this);
		Body_r32.setPos(12.0F, 7.5F, 31.0F);
		Body.addChild(Body_r32);
		setRotationAngle(Body_r32, -0.3491F, -0.2618F, 0.0F);
		Body_r32.texOffs(12, 35).addBox(-6.0F, -6.5F, 7.0F, 7.0F, 9.0F, 21.0F, 0.0F, true);

		Body_r33 = new ModelRenderer(this);
		Body_r33.setPos(-12.0F, 7.5F, 31.0F);
		Body.addChild(Body_r33);
		setRotationAngle(Body_r33, -0.3491F, 0.2618F, 0.0F);
		Body_r33.texOffs(12, 35).addBox(-1.0F, -6.5F, 7.0F, 7.0F, 9.0F, 21.0F, 0.0F, false);

		Body_r34 = new ModelRenderer(this);
		Body_r34.setPos(-12.0F, 7.5F, 31.0F);
		Body.addChild(Body_r34);
		setRotationAngle(Body_r34, 0.0F, 0.2618F, 0.0F);
		Body_r34.texOffs(12, 35).addBox(-1.0F, -4.5F, -12.0F, 6.0F, 9.0F, 20.0F, 0.0F, false);

		Body_r35 = new ModelRenderer(this);
		Body_r35.setPos(4.6711F, -13.1278F, 6.5F);
		Body.addChild(Body_r35);
		setRotationAngle(Body_r35, 0.2182F, 0.0F, 0.3927F);
		Body_r35.texOffs(0, 0).addBox(-6.5F, -1.5F, -11.5F, 13.0F, 4.0F, 23.0F, 0.0F, false);

		Body_r36 = new ModelRenderer(this);
		Body_r36.setPos(0.5F, -14.5F, 6.5F);
		Body.addChild(Body_r36);
		setRotationAngle(Body_r36, 0.2182F, 0.0F, -0.3927F);
		Body_r36.texOffs(0, 0).addBox(-12.5F, -2.5F, -11.5F, 13.0F, 4.0F, 23.0F, 0.0F, false);

		Body_r37 = new ModelRenderer(this);
		Body_r37.setPos(6.6973F, 2.1292F, -11.1161F);
		Body.addChild(Body_r37);
		setRotationAngle(Body_r37, 0.1745F, 0.3491F, -0.3491F);
		Body_r37.texOffs(0, 57).addBox(-2.1075F, 3.2583F, 4.3703F, 3.0F, 2.0F, 3.0F, 0.0F, false);
		Body_r37.texOffs(0, 57).addBox(-2.1075F, 3.2583F, -0.6297F, 3.0F, 2.0F, 3.0F, 0.0F, false);

		Body_r38 = new ModelRenderer(this);
		Body_r38.setPos(5.5959F, 12.0421F, -8.2868F);
		Body.addChild(Body_r38);
		setRotationAngle(Body_r38, -0.8665F, 0.0259F, -0.988F);
		Body_r38.texOffs(0, 58).addBox(-4.9962F, -1.3778F, 3.7196F, 2.0F, 2.0F, 3.0F, 0.0F, false);

		Body_r39 = new ModelRenderer(this);
		Body_r39.setPos(5.5959F, 12.0421F, -8.2868F);
		Body.addChild(Body_r39);
		setRotationAngle(Body_r39, -0.9183F, 0.2392F, -1.3728F);
		Body_r39.texOffs(0, 58).addBox(3.0906F, -0.3443F, -3.4187F, 2.0F, 2.0F, 3.0F, 0.0F, false);
		Body_r39.texOffs(0, 58).addBox(3.0906F, -1.3443F, 2.5813F, 2.0F, 2.0F, 3.0F, 0.0F, false);

		Body_r40 = new ModelRenderer(this);
		Body_r40.setPos(-4.2095F, 11.64F, -6.9824F);
		Body.addChild(Body_r40);
		setRotationAngle(Body_r40, 0.1745F, -0.9599F, 0.0F);
		Body_r40.texOffs(0, 58).addBox(3.3937F, 1.757F, 3.3439F, 2.0F, 2.0F, 3.0F, 0.0F, false);
		Body_r40.texOffs(0, 58).addBox(3.3937F, 2.757F, -0.6561F, 2.0F, 2.0F, 3.0F, 0.0F, false);
		Body_r40.texOffs(0, 58).addBox(0.3937F, 2.757F, -5.6561F, 2.0F, 2.0F, 3.0F, 0.0F, false);
		Body_r40.texOffs(0, 58).addBox(-4.6063F, -1.243F, -5.6561F, 2.0F, 2.0F, 3.0F, 0.0F, false);

		Body_r41 = new ModelRenderer(this);
		Body_r41.setPos(-4.2095F, 11.64F, -6.9824F);
		Body.addChild(Body_r41);
		setRotationAngle(Body_r41, -0.5172F, -0.7533F, 0.8239F);
		Body_r41.texOffs(0, 59).addBox(-4.6737F, -4.3266F, 1.9111F, 2.0F, 2.0F, 3.0F, 0.0F, false);
		Body_r41.texOffs(0, 59).addBox(-4.6737F, -2.3266F, -4.0889F, 2.0F, 2.0F, 3.0F, 0.0F, false);

		Body_r42 = new ModelRenderer(this);
		Body_r42.setPos(-6.0955F, 1.0612F, -8.7486F);
		Body.addChild(Body_r42);
		setRotationAngle(Body_r42, -0.6169F, -0.8939F, 1.8919F);
		Body_r42.texOffs(0, 59).addBox(-5.6891F, -3.3731F, 0.4253F, 2.0F, 3.0F, 2.0F, 0.0F, false);
		Body_r42.texOffs(0, 59).addBox(-1.6891F, -4.3731F, 5.4253F, 2.0F, 3.0F, 2.0F, 0.0F, false);
		Body_r42.texOffs(0, 59).addBox(6.3109F, 1.6269F, -1.5747F, 2.0F, 3.0F, 2.0F, 0.0F, false);
		Body_r42.texOffs(0, 59).addBox(2.3109F, -0.3731F, -3.5747F, 2.0F, 3.0F, 2.0F, 0.0F, false);
		Body_r42.texOffs(0, 59).addBox(-1.6891F, -2.3731F, -6.5747F, 2.0F, 3.0F, 2.0F, 0.0F, false);

		Body_r43 = new ModelRenderer(this);
		Body_r43.setPos(-6.0955F, 1.0612F, -8.7486F);
		Body.addChild(Body_r43);
		setRotationAngle(Body_r43, -1.2415F, -1.1029F, 2.6216F);
		Body_r43.texOffs(0, 59).addBox(-6.1773F, -1.9933F, -1.4206F, 2.0F, 3.0F, 3.0F, 0.0F, false);

		Body_r44 = new ModelRenderer(this);
		Body_r44.setPos(5.5959F, 12.0421F, -8.2868F);
		Body.addChild(Body_r44);
		setRotationAngle(Body_r44, -0.8679F, 0.0479F, -1.0257F);
		Body_r44.texOffs(0, 58).addBox(-0.7229F, 0.8209F, -4.1531F, 2.0F, 2.0F, 3.0F, 0.0F, false);

		Body_r45 = new ModelRenderer(this);
		Body_r45.setPos(5.5959F, 12.0421F, -8.2868F);
		Body.addChild(Body_r45);
		setRotationAngle(Body_r45, -0.8985F, -0.1912F, -0.6074F);
		Body_r45.texOffs(0, 58).addBox(-4.3375F, 0.866F, -0.8976F, 2.0F, 2.0F, 3.0F, 0.0F, false);

		Body_r46 = new ModelRenderer(this);
		Body_r46.setPos(6.6973F, 2.1292F, -11.1161F);
		Body.addChild(Body_r46);
		setRotationAngle(Body_r46, 0.5236F, 0.3491F, -0.3491F);
		Body_r46.texOffs(0, 58).addBox(-2.1075F, -6.5001F, -6.0001F, 3.0F, 2.0F, 3.0F, 0.0F, false);

		Body_r47 = new ModelRenderer(this);
		Body_r47.setPos(6.6973F, 2.1292F, -11.1161F);
		Body.addChild(Body_r47);
		setRotationAngle(Body_r47, 0.5236F, 0.7418F, -0.3491F);
		Body_r47.texOffs(0, 58).addBox(-3.6973F, -5.5801F, 4.8613F, 3.0F, 2.0F, 3.0F, 0.0F, false);
		...
		hair_r9.setPos(11.0F, 0.0F, 0.0F);
		hairr3.addChild(hair_r9);
		setRotationAngle(hair_r9, -1.8902F, -0.6185F, 2.2411F);
		hair_r9.texOffs(21, 38).addBox(7.0F, -14.0F, -2.0F, 1.0F, 16.0F, 1.0F, 0.0F, true);
		...
		bottle3_r1.setPos(12.6068F, -6.6614F, 0.8752F);
		RightArm.addChild(bottle3_r1);
		setRotationAngle(bottle3_r1, 1.9199F, 2.5307F, 2.5744F);
		bottle3_r1.texOffs(13, 25).addBox(-5.0F, -1.0F, -6.5F, 10.0F, 2.0F, 13.0F, 0.0F, false);

		bottle2_r2 = new ModelRenderer(this);
		bottle2_r2.setPos(5.8765F, 0.9772F, 7.1106F);
		RightArm.addChild(bottle2_r2);
		setRotationAngle(bottle2_r2, -1.0035F, -0.9377F, 0.0885F);
		bottle2_r2.texOffs(32, 42).addBox(-3.0642F, -3.1314F, -9.5661F, 1.0F, 2.0F, 1.0F, 0.0F, false);
		...
		bottle2_r3 = new ModelRenderer(this);
		bottle2_r3.setPos(0.0F, -0.9487F, -0.0622F);
		leftfront.addChild(bottle2_r3);
		setRotationAngle(bottle2_r3, -0.1745F, 0.0F, 0.0F);
		bottle2_r3.texOffs(32, 42).addBox(-1.0F, -13.8569F, -11.4712F, 1.0F, 2.0F, 1.0F, 0.0F, false);
		bottle2_r3.texOffs(32, 42).addBox(0.0F, -13.8569F, -10.4712F, 1.0F, 2.0F, 1.0F, 0.0F, false);
		bottle2_r3.texOffs(32, 42).addBox(0.0F, -13.8569F, -9.4712F, 1.0F, 2.0F, 1.0F, 0.0F, false);
		bottle2_r3.texOffs(32, 42).addBox(-1.0F, -13.8569F, -9.4712F, 1.0F, 2.0F, 1.0F, 0.0F, false);
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
		...
		this.eye_r1.zRot = netHeadYaw * 0.002453292F;
	}
