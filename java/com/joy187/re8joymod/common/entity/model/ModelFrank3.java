...
public class ModelFrank3<T extends EntityFrank3> extends EntityModel<T> {
	...
	public ModelFrank3() {
		...
		setRotationAngle(Head_r1, 2.2253F, 0.0F, 0.0F);
		Head_r1.texOffs(35, 27).addBox(-1.0F, -2.0F, -2.0F, 2.0F, 2.0F, 2.0F, 0.0F, false);

		Head_r2 = new ModelRenderer(this);
		Head_r2.setPos(0.0F, 2.912F, -5.7491F);
		Head.addChild(Head_r2);
		setRotationAngle(Head_r2, 1.789F, 0.0F, 0.0F);
		Head_r2.texOffs(43, 9).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 2.0F, 4.0F, 0.0F, false);
		...
		RightArm_r2.setPos(-0.5F, 4.4119F, -0.9466F);
		...
		RightArm_r3.setPos(0.3916F, -6.6013F, -0.5854F);
		knife.addChild(RightArm_r3);
		setRotationAngle(RightArm_r3, 1.0472F, 0.0F, 0.0F);
		RightArm_r3.texOffs(22, 59).addBox(-0.8916F, 0.9872F, -10.0758F, 1.0F, 1.0F, 4.0F, 0.0F, false);

		RightArm_r4 = new ModelRenderer(this);
		RightArm_r4.setPos(0.3916F, -3.7813F, 0.7669F);
		knife.addChild(RightArm_r4);
		setRotationAngle(RightArm_r4, 0.1309F, 0.0F, 0.0F);
		RightArm_r4.texOffs(22, 59).addBox(-0.8916F, 2.4489F, -3.8882F, 1.0F, 1.0F, 4.0F, 0.0F, false);

		RightArm_r5 = new ModelRenderer(this);
		RightArm_r5.setPos(0.3916F, -4.1893F, 0.507F);
		knife.addChild(RightArm_r5);
		setRotationAngle(RightArm_r5, -0.5672F, 0.0F, 0.0F);
		RightArm_r5.texOffs(22, 59).addBox(-0.8916F, 2.0085F, 2.0981F, 1.0F, 1.0F, 4.0F, 0.0F, false);

		RightArm_r6 = new ModelRenderer(this);
		RightArm_r6.setPos(0.3916F, -2.7934F, 0.5466F);
		knife.addChild(RightArm_r6);
		setRotationAngle(RightArm_r6, -1.0036F, 0.0F, 0.0F);
		RightArm_r6.texOffs(21, 60).addBox(-0.8916F, 4.0981F, 0.0085F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		RightArm_r6.texOffs(21, 60).addBox(-0.8916F, 0.0981F, 1.0085F, 1.0F, 1.0F, 1.0F, 0.0F, false);

		RightArm_r7 = new ModelRenderer(this);
		RightArm_r7.setPos(0.3916F, -2.7934F, 0.5466F);
		knife.addChild(RightArm_r7);
		setRotationAngle(RightArm_r7, -0.6981F, 0.0F, 0.0F);
		RightArm_r7.texOffs(21, 60).addBox(-0.8916F, -0.2215F, 3.4119F, 1.0F, 1.0F, 1.0F, 0.0F, false);

		RightArm_r8 = new ModelRenderer(this);
		RightArm_r8.setPos(0.3916F, -2.7934F, 0.5466F);
		knife.addChild(RightArm_r8);
		setRotationAngle(RightArm_r8, -0.48F, 0.0F, 0.0F);
		RightArm_r8.texOffs(21, 60).addBox(-0.8916F, 1.1383F, 2.8734F, 1.0F, 3.0F, 1.0F, 0.0F, false);

		RightArm_r9 = new ModelRenderer(this);
		RightArm_r9.setPos(0.3916F, -2.7498F, -0.4525F);
		knife.addChild(RightArm_r9);
		setRotationAngle(RightArm_r9, -0.1745F, 0.0F, 0.0F);
		RightArm_r9.texOffs(21, 60).addBox(-0.8916F, 6.4291F, 0.0165F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		RightArm_r9.texOffs(21, 60).addBox(-0.8916F, 6.4291F, -1.9835F, 1.0F, 2.0F, 1.0F, 0.0F, false);

		RightArm_r10 = new ModelRenderer(this);
		RightArm_r10.setPos(0.3916F, -2.7498F, -0.4525F);
		knife.addChild(RightArm_r10);
		setRotationAngle(RightArm_r10, 0.5236F, 0.0F, 0.0F);
		RightArm_r10.texOffs(21, 60).addBox(-0.8916F, 1.0758F, -3.9872F, 1.0F, 2.0F, 1.0F, 0.0F, false);

		RightArm_r11 = new ModelRenderer(this);
		RightArm_r11.setPos(0.3916F, -0.9698F, 4.63F);
		knife.addChild(RightArm_r11);
		setRotationAngle(RightArm_r11, 0.0436F, 0.0F, 0.0F);
		RightArm_r11.texOffs(21, 60).addBox(-0.8916F, -0.5285F, -5.6297F, 1.0F, 3.0F, 1.0F, 0.0F, false);
		RightArm_r11.texOffs(21, 54).addBox(-3.8916F, 1.4715F, -6.6297F, 1.0F, 2.0F, 4.0F, 0.0F, false);
		RightArm_r11.texOffs(21, 54).addBox(-0.8916F, 2.4715F, -8.6297F, 1.0F, 2.0F, 8.0F, 0.0F, false);

		RightArm_r12 = new ModelRenderer(this);
		RightArm_r12.setPos(-5.0F, 1.244F, 0.157F);
		knife.addChild(RightArm_r12);
		setRotationAngle(RightArm_r12, -1.0908F, 0.0F, 0.0F);
		RightArm_r12.texOffs(21, 54).addBox(-0.5F, -1.0F, -1.5F, 1.0F, 2.0F, 3.0F, 0.0F, false);

		RightArm_r13 = new ModelRenderer(this);
		RightArm_r13.setPos(-3.0F, 2.744F, -0.843F);
		knife.addChild(RightArm_r13);
		setRotationAngle(RightArm_r13, -1.5708F, 0.0F, 0.0F);
		RightArm_r13.texOffs(21, 54).addBox(-0.5F, -2.0F, -4.0F, 1.0F, 2.0F, 5.0F, 0.0F, false);

		RightArm_r14 = new ModelRenderer(this);
		RightArm_r14.setPos(-6.0F, 1.7013F, 0.1125F);
		knife.addChild(RightArm_r14);
		setRotationAngle(RightArm_r14, 0.5672F, 0.0F, 0.0F);
		RightArm_r14.texOffs(21, 54).addBox(-0.5F, -1.0F, -2.0F, 1.0F, 2.0F, 4.0F, 0.0F, false);
		...
		RightArm_r15.setPos(1.6951F, -11.9346F, -2.9047F);
		knife2.addChild(RightArm_r15);
		setRotationAngle(RightArm_r15, 1.0472F, 0.0F, 0.0F);
		RightArm_r15.texOffs(22, 59).addBox(-0.8916F, 2.9872F, -10.0758F, 1.0F, 1.0F, 3.0F, 0.0F, false);

		RightArm_r16 = new ModelRenderer(this);
		RightArm_r16.setPos(1.6951F, -9.1146F, -1.5524F);
		knife2.addChild(RightArm_r16);
		setRotationAngle(RightArm_r16, 0.1309F, 0.0F, 0.0F);
		RightArm_r16.texOffs(22, 59).addBox(-0.8916F, 3.4489F, -3.8882F, 1.0F, 1.0F, 3.0F, 0.0F, false);

		RightArm_r17 = new ModelRenderer(this);
		RightArm_r17.setPos(1.6951F, -9.5225F, -1.8123F);
		knife2.addChild(RightArm_r17);
		setRotationAngle(RightArm_r17, -0.5672F, 0.0F, 0.0F);
		RightArm_r17.texOffs(22, 59).addBox(1.1084F, 4.0085F, 2.0981F, 1.0F, 1.0F, 3.0F, 0.0F, false);

		RightArm_r18 = new ModelRenderer(this);
		RightArm_r18.setPos(1.6951F, -8.1267F, -1.7728F);
		knife2.addChild(RightArm_r18);
		setRotationAngle(RightArm_r18, -1.0036F, 0.0F, 0.0F);
		RightArm_r18.texOffs(21, 60).addBox(-0.8916F, 4.0981F, 0.0085F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		RightArm_r18.texOffs(21, 60).addBox(-0.8916F, 2.0981F, 1.0085F, 1.0F, 1.0F, 1.0F, 0.0F, false);

		RightArm_r19 = new ModelRenderer(this);
		RightArm_r19.setPos(3.679F, -8.3489F, 0.0125F);
		knife2.addChild(RightArm_r19);
		setRotationAngle(RightArm_r19, -1.0036F, 0.0F, 0.0F);
		RightArm_r19.texOffs(21, 60).addBox(1.1084F, 5.0981F, 2.0085F, 3.0F, 1.0F, 1.0F, 0.0F, false);

		RightArm_r20 = new ModelRenderer(this);
		RightArm_r20.setPos(1.6951F, -8.1267F, -1.7728F);
		knife2.addChild(RightArm_r20);
		setRotationAngle(RightArm_r20, -0.6981F, 0.0F, 0.0F);
		RightArm_r20.texOffs(21, 60).addBox(0.1084F, 1.7785F, 2.4119F, 1.0F, 1.0F, 1.0F, 0.0F, false);

		RightArm_r21 = new ModelRenderer(this);
		RightArm_r21.setPos(1.6951F, -8.1267F, -1.7728F);
		knife2.addChild(RightArm_r21);
		setRotationAngle(RightArm_r21, -0.48F, 0.0F, 0.0F);
		RightArm_r21.texOffs(21, 60).addBox(-0.8916F, 2.1383F, 2.8734F, 1.0F, 2.0F, 1.0F, 0.0F, false);

		RightArm_r22 = new ModelRenderer(this);
		RightArm_r22.setPos(1.6951F, -8.083F, -2.7718F);
		knife2.addChild(RightArm_r22);
		setRotationAngle(RightArm_r22, 0.5236F, 0.0F, 0.0F);
		RightArm_r22.texOffs(21, 60).addBox(-0.8916F, 2.0758F, -3.9872F, 1.0F, 1.0F, 1.0F, 0.0F, false);

		RightArm_r23 = new ModelRenderer(this);
		RightArm_r23.setPos(1.6951F, -6.303F, 2.3107F);
		knife2.addChild(RightArm_r23);
		setRotationAngle(RightArm_r23, 0.0436F, 0.0F, 0.0F);
		RightArm_r23.texOffs(21, 60).addBox(-0.8916F, 1.4715F, -5.6297F, 1.0F, 1.0F, 1.0F, 0.0F, false);
